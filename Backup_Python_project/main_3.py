...
def generate_purchase_type_wise(path):
    ...
    # apply comma format to numbers - not working
    ...
    purchase_type_wise_comparatives_pd.to_excel("Output.xlsx", sheet_name="Purchase Type Wise Comparatives", index=False)

    # openpyxl starts here
    workbook_object = openpyxl.load_workbook("Output.xlsx")
    ...
    workbook_object.save("Output.xlsx")
